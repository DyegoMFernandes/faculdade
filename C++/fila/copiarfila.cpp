...
void copiar(tipo_fila &fila, tipo_fila &fila2) {
	fila2.tras = fila.tras;
    for (int i = 0; i <= fila.tras; i++) {
        fila2.dados[i] = fila.dados[i];
    }
}
...
int main() {
    ...
    do {
        ...
        cout << "2 - Copiar Fila1 para Fila2" << endl;
        cout << "3 - Exibir" << endl;
        cout << "0 - Sair" << endl;
        ...
        switch (opcao) {
            ...
            case 2:
            	system("cls");
                cout << "copiado para fila2 com sucesso!";
				copiar(f1,f2);
				break;
            case 3:
				system("cls");
